...
var first_score = 0; // Variável que armazena o valor correspondente a primeira pontuação adquirida pelo jogador 

var actual_score = 0; // Variável que armazena o valor correspondente a pontuação da ultima tentativa do jogador 

var best_score = 0; // Variável que armazena o valor correspondente a melhor pontuação do jogador dentre todas as tentativas
...
function gameover (){
  ...
  if(best_score > actual_score && best_score != actual_score){
    $("h4").text("" + best_score - 1);
  } 
  else {
    $("h4").text("" + actual_score - 1);
    best_score = actual_score;
  }
